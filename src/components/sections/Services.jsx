      ...
      >
        ...
        >
          ...
          >
            ...
            <motion.span 
              className="absolute inset-0 bg-gradient-to-r from-primary to-primary-hover z-0"
            />
            <motion.span 
              className="absolute -right-12 -bottom-12 w-24 h-24 bg-white/10 rounded-full z-0 opacity-0 group-hover:opacity-40 transition-opacity duration-300"
              initial={{ scale: 0 }}
